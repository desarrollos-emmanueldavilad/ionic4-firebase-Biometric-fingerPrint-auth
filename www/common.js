...
/***/ "./src/app/services/touch-id.service.ts":
/*!**********************************************!*\
  !*** ./src/app/services/touch-id.service.ts ***!
  \**********************************************/
/*! exports provided: TouchIdService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TouchIdService", function() { return TouchIdService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_native_keychain_touch_id_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic-native/keychain-touch-id/ngx */ "./node_modules/@ionic-native/keychain-touch-id/ngx/index.js");



var TouchIdService = /** @class */ (function () {
    function TouchIdService(keychainTouchId) {
     ...
     **/
    TouchIdService.prototype.available = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.keychainTouchId
                ...
                .catch(function (err) {
                return console.error('Se ha producido un error en Available: ', err);
            });
        });
    };
    /**
     ...
     *}
     **/
    TouchIdService.prototype.verify = function (key) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.keychainTouchId
                ...
                .catch(function (err) {
                return console.error('Se ha producido un error en Verify: ', err);
            });
        });
    };
    /**
     ...
     *    })
     **/
    TouchIdService.prototype.has = function (key) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.keychainTouchId
                .has(key)
                .then(function (res) { return resolve(res); })
                .catch(function (err) { return console.error('Se ha producido un error en Has: ', err); });
        });
    };
    /**
     ...
     * }
     **/
    TouchIdService.prototype.remove = function (key) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.keychainTouchId
                .delete(key)
                ...
                .catch(function (err) {
                return console.error('Se ha producido un error en Delete: ', err);
            });
        });
    };
    TouchIdService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_keychain_touch_id_ngx__WEBPACK_IMPORTED_MODULE_2__["KeychainTouchId"]])
    ], TouchIdService);
